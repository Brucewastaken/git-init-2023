...
var hiddenArray = ["window", "OleMainThreadWndName", "search", "start", "notification", "wacom", "App Usage Monitor", "logitech", "wnd"];
var strictSystemArray = ["lighshot.exe", "NVIDIA web helper.exe", "SystemSettings.exe", "smartscreen.exe", "svchost.exe", "taskhostw.exe", "tabtip.exe", "startmenuexperiencehost.exe", "runtimebroker.exe", "searchapp.exe", "ShellExperienceHost.exe", "dllhost.exe", "TextInputHost.exe", "RtkAudUService64.exe", "WavesSvc64.exe", "ModuleCoreService.exe", "taskhostw.exe", "igfxEM.exe", "electron.exe", "ApplicationFrameHost.exe", "CalculatorApp.exe" ];
